	...
	<body>
		<div id="wrapper">
			...
			<div id="upperThirdContent">
					...
					<?php echo form_open('site/editPageSubmit/'.$pageData->pageId, array('class' => 'newPageForm')); ?>
					<div id="controlBar">
						...
						<ul>
							<li><?php echo form_submit(array('class' => 'controlBarButton', 'name' => 'editpagesubmit', 'value' => '> Save Page')); ?></li>
							<li><?php echo anchor('site/canceleditpage/'.$pageData->pageId, '&gt; Cancel' , array('class' => 'controlBarButton'));?></li>
						</ul>
					</div><!--end controlBar-->
					...
					<div id="pageMainContentWrapper">
						<div id="pageMainContent">
							<h2>Editing - <?php echo $pageData->pageName ?></h2>
							<input type="text" name="editpage_pagetitle" value="<?php echo $pageData->pageName; ?>" id="editpage_pagetitle" />
							<textarea name="editpage_pagecontent" cols="40" rows="10" id="editpage_pagecontent" ><?php echo $pageData->pageContent; ?></textarea>
